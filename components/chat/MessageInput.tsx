  ...
  return (
    <div className="flex shrink-0 items-end gap-2 border-t border-slate-800 bg-slate-900 px-3 py-3">
      <textarea
        ...
        rows={1}
        maxLength={2000}
        className="flex-1 resize-none rounded-xl border border-slate-700 bg-slate-800 px-3.5 py-2.5 text-sm text-white placeholder-slate-500 outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-500/30"
